...
(function($) {
    ...
    $.fn.lightBox = function(settings) {
        ...
        settings = jQuery.extend({
            ...
            imageLoading:           '/public/design/img/lightbox-ico-loading.gif',      // (string) Path and the name of the loading icon
            imageBtnPrev:           '/public/design//img/lightbox-btn-prev.gif',            // (string) Path and the name of the prev button image
            imageBtnNext:           '/public/design/img/lightbox-btn-next.gif',         // (string) Path and the name of the next button image
            imageBtnClose:          '/public/design/img/lightbox-btn-close.gif',        // (string) Path and the name of the close btn
            imageBlank:             '/public/design/img/lightbox-blank.gif',            // (string) Path and the name of a blank image (one pixel)
