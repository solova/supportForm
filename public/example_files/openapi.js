...
if (!VK.Widgets) {
  ...
  VK.Widgets.Ads = function(objId, options, paramsExtra) {
    ...
    VK.extend(params, paramsExtra);

    var width  = (paramsExtra && parseInt(paramsExtra.ads_ad_unit_width) || 100);
    var height = (paramsExtra && parseInt(paramsExtra.ads_ad_unit_height) || 100);
